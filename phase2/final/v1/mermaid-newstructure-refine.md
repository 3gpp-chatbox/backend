...
graph TD;
  ...
  AMF_Registered;
  UE_Deregistered -- "E_REGISTRATION_REQUEST" --> UE_Attempting_Initial_Registration;
  UE_Deregistered -- "E_REGISTRATION_REQUEST" --> AMF_Processing_Initial_Registration;
  AMF_Idle -- "E_REGISTRATION_REQUEST" --> AMF_Processing_Initial_Registration;
  AMF_Processing_Initial_Registration -- "E_REGISTRATION_ACCEPT_ReqComplete" --> AMF_Waiting_Registration_Complete;
  AMF_Processing_Initial_Registration -- "E_REGISTRATION_ACCEPT_ReqComplete" --> UE_Sending_RegComplete;
  AMF_Processing_Initial_Registration -- "E_REGISTRATION_ACCEPT_NoComplete" --> AMF_Registered;
  AMF_Processing_Initial_Registration -- "E_REGISTRATION_ACCEPT_NoComplete" --> UE_Registered;
  AMF_Processing_Initial_Registration -- "E_REGISTRATION_REJECT" --> AMF_Idle;
  AMF_Processing_Initial_Registration -- "E_REGISTRATION_REJECT" --> UE_Registration_Rejected;
  ...
  UE_Sending_RegComplete -- "E_REGISTRATION_COMPLETE" --> UE_Registered;
  UE_Sending_RegComplete -- "E_REGISTRATION_COMPLETE" --> AMF_Registered;
