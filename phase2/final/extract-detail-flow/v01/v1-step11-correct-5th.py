...
def process_procedure(section_name):
    ...
    extracted_data = read_json_file("v1-step9-correct-4th.json")
    evaluation = read_text_file("v1-step10-evaluate-5th.json")
...
if procedural_info:
    save_to_json(procedural_info, "v1-step11-correct-5th.json")
else:
