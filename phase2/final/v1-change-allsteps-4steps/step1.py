...
- **Nodes** represent **states or events**.for all entities involved (UE, AMF, etc.)
    ...
    - **Events:** visible triggers such as received messages or expired timers (e.g., "Receive DEREGISTRATION REQUEST", "T3510 expires", "Lower layer failure"). Events describe occurrences/trigger that happen .
