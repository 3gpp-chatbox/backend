...
def process_procedure(section_name):
    ...
    step1_data = read_json_file("v02-step1-newmodel.json")
    step2_data = read_json_file("v02-step2-newmodel.json")
...
if procedural_info:
    save_to_json(procedural_info, "v02-step3-simple-newmodel.json")
else:
    print("Failed to extract procedural information")
if save_to_json:
   clean_json("v02-step3-simple-newmodel.json")
else:
