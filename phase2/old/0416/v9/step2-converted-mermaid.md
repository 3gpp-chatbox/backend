...
graph LR
    ...
    5GMM-REGISTERED-INITIATED -->|"No Condition (5.5.1.2.4)"| Receive_REGISTRATION_ACCEPT
    ...
    5GMM-REGISTERED-INITIATED -->|"No Condition (5.5.1.2.5)"| Receive_REGISTRATION_REJECT
    ...
    Receive_REGISTRATION_REJECT -->|"Cause #11(3GPP)/#73(3GPP)/#36/#78/#80; Action: Set status 5U3, Delete context, Add forbidden (5.5.1.2.5)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    Receive_REGISTRATION_REJECT -->|"Cause #12/#13(Option)/#15/#27; Action: Set status 5U3, Delete TAI list, Add forbidden TAI (5.5.1.2.5)"| 5GMM-DEREGISTERED.LIMITED-SERVICE
    ...
    Receive_REGISTRATION_REJECT -->|"Cause #62(Option)/#79(Option)/#81(Option)/#82(Option); Action: Set status 5U2, Store rejected NSSAI (if #62) (5.5.1.2.5)"| 5GMM-DEREGISTERED.ATTEMPTING-REGISTRATION
    Receive_REGISTRATION_REJECT -->|"Cause #62(Option)/#79(Option)/#81(Option)/#82(Option); Action: Set status 5U2, Store rejected NSSAI (if #62) (5.5.1.2.5)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    ...
    Receive_REGISTRATION_REJECT -->|"Cause #74(3GPP)/#75(3GPP) (SNPN); Action: Set status 5U3, Delete context, Add forbidden SNPN (5.5.1.2.5)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    Receive_REGISTRATION_REJECT -->|"Cause #74(non-3GPP)/#75(non-3GPP) (SNPN); Action: Set status 5U3, Delete context, Add forbidden SNPN (5.5.1.2.5)"| 5GMM-DEREGISTERED.LIMITED-SERVICE
    Receive_REGISTRATION_REJECT -->|"Cause #76 (CAG - PLMN Search Option); Action: Set status 5U3, Update CAG list (5.5.1.2.5)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    Receive_REGISTRATION_REJECT -->|"Cause #76 (CAG - Limited Service Option); Action: Set status 5U3, Update CAG list (5.5.1.2.5)"| 5GMM-DEREGISTERED.LIMITED-SERVICE
    ...
    Receive_REGISTRATION_REJECT -->|"Abnormal Cause & Counter = 5 (Option); Action: Abort, Delete context, Start T3502, Set status 5U2 (5.5.1.2.7 d)"| 5GMM-DEREGISTERED.ATTEMPTING-REGISTRATION
    Receive_REGISTRATION_REJECT -->|"Abnormal Cause & Counter = 5 (Option); Action: Abort, Delete context, Start T3502, Set status 5U2 (5.5.1.2.7 d)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    ...
    Event_T3510_Expiry -->|"Counter = 5 (Option); Action: Abort, Delete context, Start T3502, Set status 5U2 (5.5.1.2.7)"| 5GMM-DEREGISTERED.ATTEMPTING-REGISTRATION
    Event_T3510_Expiry -->|"Counter = 5 (Option); Action: Abort, Delete context, Start T3502, Set status 5U2 (5.5.1.2.7)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    5GMM-REGISTERED-INITIATED -->|"No Condition (5.5.1.2.7 e)"| Event_LowerLayer_Failure
    ...
    Event_LowerLayer_Failure -->|"Counter = 5 & Not Emergency (Option); Action: Abort, Delete context, Start T3502, Set status 5U2 (5.5.1.2.7)"| 5GMM-DEREGISTERED.ATTEMPTING-REGISTRATION
    Event_LowerLayer_Failure -->|"Counter = 5 & Not Emergency (Option); Action: Abort, Delete context, Start T3502, Set status 5U2 (5.5.1.2.7)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    5GMM-REGISTERED-INITIATED -->|"No Condition (5.5.1.2.7 f)"| Event_UE_Deregistration_Required
    ...
    5GMM-DEREGISTERED.ATTEMPTING-REGISTRATION -->|"No Condition (5.5.1.2.7)"| Event_T3511_Expiry
    Event_T3511_Expiry -->|"Action: Restart initial registration (5.5.1.2.7)"| 5GMM-DEREGISTERED
    5GMM-DEREGISTERED.ATTEMPTING-REGISTRATION -->|"No Condition (5.5.1.2.7 a)"| Event_T3346_Expiry
    ...
    5GMM-DEREGISTERED -->|"No Condition (5.5.1.2.7 b)"| Event_Access_Barred
    Event_Access_Barred -->|"Action: Do not start procedure (5.5.1.2.7 b)"| 5GMM-DEREGISTERED
    5GMM-REGISTERED-INITIATED -->|"No Condition (5.5.1.2.7 k)"| Event_REG_REQUEST_Tx_Failure
    ...
    Receive_REGISTRATION_REJECT -->|"Cause #11 (non-3GPP); Action: Set status 5U3, Delete context, Add forbidden (5.5.1.2.5)"| 5GMM-DEREGISTERED.LIMITED-SERVICE
    Receive_REGISTRATION_REJECT -->|"Cause #13 (Option); Action: Set status 5U3, Delete TAI list, Add forbidden TAI (5.5.1.2.5)"| 5GMM-DEREGISTERED.PLMN-SEARCH
    Receive_REGISTRATION_REJECT -->|"Cause #73 (non-3GPP); Action: Set status 5U3, Delete context, Add forbidden (5.5.1.2.5)"| 5GMM-DEREGISTERED.LIMITED-SERVICE
    5GMM-REGISTERED -->|"After REG ACCEPT, TAI changed (5.5.1.2.7 i)"| Event_REG_COMPLETE_Tx_Failure_TAI_Change
    Event_REG_COMPLETE_Tx_Failure_TAI_Change -->|"New TAI in list; Action: Resend REG COMPLETE (5.5.1.2.7 i)"| 5GMM-REGISTERED
```