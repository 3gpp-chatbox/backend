...
Only return JSON object, **do not include any comments or additional explanations**.
...
{{
  ...
  "edges": [
    {{
      ...
      "to": "target_node_name",
      "action": [
        "Send REGISTRATION REQUEST" // A brief description of the action (e.g., "Send REGISTRATION REQUEST message")
      ],
      "condition": [
        "A brief description of conditions that cause the transition (e.g., 'Timer T3346 is not running')."
      ],
