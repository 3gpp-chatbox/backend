...
def extract_procedural_info_from_text(section_name, text):
    prompt = f"""
Extract all the states involved in the procedure {section_name} on the UE side from the following section of the 3GPP specification, extract all no matter main states or substates,but only extract Explicitly named states mentioned in the text and only on the UE side.
