...
def process_procedure(section_name):
    ...
    extracted_data = read_json_file("v1-step7-correct-3rd.json")
    evaluation = read_text_file("v1-step8-evaluate-4th.json")
...
if procedural_info:
    save_to_json(procedural_info, "v1-step9-correct-4th.json")
else:
