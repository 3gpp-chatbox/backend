...
def process_procedure(section_name):
    ...
    extracted_data = read_json_file("v1-step6-correctagain.json")
    evaluation = read_text_file("v1-step7-evaluate-3rd.json")
...
if procedural_info:
    save_to_json(procedural_info, "v1-step8-correct-3rd.json")
else:
