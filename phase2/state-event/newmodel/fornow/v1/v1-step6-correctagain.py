...
def process_procedure(section_name):
    ...
    extracted_data = read_json_file("v1-step4-correct.json")
    evaluation = read_text_file("v1-step5-evaluateagain.json")
...
if procedural_info:
    save_to_json(procedural_info, "v1-step6-correctagain.json")
else:
