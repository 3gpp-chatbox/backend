...
CREATE TABLE IF NOT EXISTS content (
    ...
    summary TEXT,  -- New column for summaries
...
for i in range(1, len(sections), 5):
    ...
    cursor.execute('''
    INSERT OR REPLACE INTO content (section_id, section_name, parent_section_id, parent_section_name, section_level, content_chunk, full_section_heading, summary)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
