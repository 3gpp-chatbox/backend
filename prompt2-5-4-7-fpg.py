...
def extract_procedural_info_from_text(text):
    ...
    If the text contains an **FPG (Flow Property Graph) JSON structure**, please validate and correct any mistakes in the JSON formatting and logic.  
    ...
    **Return only the corrected JSON**—no additional explanations, comments, or formatting outside of JSON.  
    """  
...
procedural_info = process_document("procedure5-4-7-fpg.txt")

# Save the extracted procedural info to a .json file
save_procedural_info_to_json(procedural_info, "procedure5-4-7-fpg.json")
